...
assert (main["manager"] / "libexec/build-runtime.py").is_file()
assert (main["manager"] / "termux-notify.sh").is_file()
assert (main["manager"] / "codex-turn-notify.sh").is_file()
assert os.access(main["manager"] / "termux-notify.sh", os.X_OK)
assert os.access(main["manager"] / "codex-turn-notify.sh", os.X_OK)
